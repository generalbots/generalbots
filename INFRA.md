...
| botui cant reach server | Wrong URL | BOTSERVER_URL=http://localhost:{PORT} |
| Suggestions missing | .bas error | Check logs, clear /opt/gbo/work/ AST cache |
| Switchers not rendering | No cache connection | Check Vault gbo/cache secret, verify cache container running |
