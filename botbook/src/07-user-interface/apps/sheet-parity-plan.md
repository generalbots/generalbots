...
| E7 | Number formats: scientific, fractions, accounting alignment, locale rendering | #785 | **Partial.** Scientific (`0.00E+00`), fraction (`# ?/?`, `# ??/??`) and accounting (parenthesised negatives, `_`/`*` marker stripping) renderers landed with tests; grid alignment of accounting currency/decimal columns and pt-BR `R$ 1.234,50` locale rendering remain. |
