...
| 12 | ~~Selection is one cell and one overlay element.~~ **Partially shipped (2026-08-09)** | Range drag-selection, Shift+click extension, `Ctrl+A` select-all, and row/column selection via header clicks. Multi-range selection still planned. → issue 6 |
