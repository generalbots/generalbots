...
| `.xls` / `.xlsb` | Partial | — | Cell values, typed cells and formulas are read via calamine; styles, merges, charts and layout are not (BIFF reader exposes values/formulas only). |
| Markdown | — | Available | — |
