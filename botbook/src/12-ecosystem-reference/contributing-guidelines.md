# Instructions for Logging Issues 🟡 BETA

## 1. Search for Duplicates

[Search the existing issues](https://github.com/generalbots/generalbots/issues) before logging a new one.
...
A bug must have an issue tracking it in the issue tracker that has been approved by the generalbots.org team. Your pull request should include a link to the bug that you are fixing. If you've submitted a PR for a bug, please post a comment in the bug to avoid duplication of effort.
...
We appreciate community contributions to code repositories open sourced by generalbots.org. By signing a contributor license agreement, we ensure that the community is free to use your contributions. 
