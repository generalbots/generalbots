...
settings-create-api-key = Create API Key
settings-api-key-name = Key Name
settings-api-key-scopes = Scopes (comma-separated)
settings-api-key-scopes-hint = Leave empty for the default "user" scope.
settings-api-key-expiry = Expires in (days)
settings-api-key-expiry-hint = Leave empty for no expiration.
settings-add-webhook = Add Webhook
settings-webhook-url = Webhook URL
settings-webhook-events = Events (comma-separated)
settings-webhook-events-hint = Leave empty to receive all events.
...
compliance-new-framework = New
compliance-framework-name = Name
compliance-framework-version = Version
compliance-framework-description = Description
compliance-create-framework = Create Framework
compliance-controls = Controls
compliance-add-control = Add Control
compliance-control-id = Control ID
compliance-control-title = Title
compliance-control-category = Category
compliance-control-description = Description
compliance-mandatory = Mandatory
compliance-optional = Optional
compliance-evidence = Evidence
compliance-attach-evidence = Attach Evidence
compliance-evidence-path = File path (drive artifact)
compliance-evidence-type = Type
compliance-approve = Approve
compliance-covered = Covered
compliance-no-evidence = No evidence
compliance-export-csv = Export CSV
...
# VDI (remote desktop)
vdi-title = Virtual Desktop
vdi-new-connection = New Connection
vdi-connection-name = Connection Name
vdi-host = Host
vdi-port = Port
vdi-protocol = Protocol
vdi-rdp-password = RDP Password
vdi-rdp-domain = RDP Domain (optional)
vdi-save-connect = Save & Connect
vdi-cancel = Cancel
vdi-connect = Connect
vdi-delete = Delete
vdi-no-connections = No connections yet
vdi-create-first = Create a new connection to get started
vdi-connecting = Connecting...
vdi-connected = Connected
vdi-disconnected = Disconnected
vdi-error = Error
vdi-clipboard-sent = Clipboard sent
vdi-ctrl-alt-del-sent = Ctrl+Alt+Del sent
vdi-rdp = RDP
vdi-vnc = VNC
attendant-attach = Attach file
attendant-emoji = Emoji
attendant-uploading = Uploading...
attendant-attach-error = Upload failed
attendant-emoji-search = Search emoji...
meet-record = Record
meet-record-title = Record Meeting
meet-recording = Recording
meet-recordings = Recordings
meet-recordings-empty = No recordings yet

player-playlists = Playlists
player-playlist-new = New playlist
player-playlist-name = Playlist name
player-playlist-create = Create
player-playlist-rename = Rename
player-playlist-delete = Delete playlist
player-playlist-add = Add to playlist
player-playlist-remove = Remove
player-playlist-play = Play
player-playlist-empty = No playlist created
player-playlist-empty-items = Empty playlist
player-playlist-add-current = + Add current media
player-playlist-created = Playlist created
player-playlist-deleted = Playlist deleted
player-playlist-renamed = Playlist renamed
