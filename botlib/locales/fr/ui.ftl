...
settings-create-api-key = Créer une clé API
settings-api-key-name = Nom de la clé
settings-api-key-scopes = Portées (séparées par des virgules)
settings-api-key-scopes-hint = Laissez vide pour la portée « utilisateur » par défaut.
settings-api-key-expiry = Expire dans (jours)
settings-api-key-expiry-hint = Laissez vide sans expiration.
settings-add-webhook = Ajouter un webhook
settings-webhook-url = URL du webhook
settings-webhook-events = Événements (séparés par des virgules)
settings-webhook-events-hint = Laissez vide pour recevoir tous les événements.
...
meet-record = Enregistrer
meet-record-title = Enregistrer la réunion
meet-recording = Enregistrement
meet-recordings = Enregistrements
meet-recordings-empty = Aucun enregistrement

player-playlists = Listes de lecture
player-playlist-new = Nouvelle liste de lecture
player-playlist-name = Nom de la liste de lecture
player-playlist-create = Créer
player-playlist-rename = Renommer
player-playlist-delete = Supprimer la liste de lecture
player-playlist-add = Ajouter à la playlist
player-playlist-remove = Supprimer
player-playlist-play = Jouer
player-playlist-empty = Aucune playlist créée
player-playlist-empty-items = Liste de lecture vide
player-playlist-add-current = + Ajouter le média actuel
player-playlist-created = Liste de lecture créée
player-playlist-deleted = Liste de lecture supprimée
player-playlist-renamed = Liste de lecture renommée
