...
settings-create-api-key = APIキーの作成
settings-api-key-name = キー名
settings-api-key-scopes = スコープ (カンマ区切り)
settings-api-key-scopes-hint = デフォルトの「user」スコープの場合は空のままにします。
settings-api-key-expiry = 有効期限は (日) で切れます
settings-api-key-expiry-hint = 有効期限を設けない場合は空のままにします。
settings-add-webhook = Webhook の追加
settings-webhook-url = Webhook URL
settings-webhook-events = イベント (カンマ区切り)
settings-webhook-events-hint = すべてのイベントを受信するには、空のままにします。
...
vdi-rdp = RDP
vdi-vnc = VNC
attendant-attach = ファイルを添付
attendant-emoji = 絵文字
attendant-uploading = アップロード中...
attendant-attach-error = アップロードに失敗しました
attendant-emoji-search = 絵文字を検索...
meet-record = 録画
meet-record-title = 会議を録画
meet-recording = 録画中
meet-recordings = 録画
meet-recordings-empty = 録画はまだありません

player-playlists = プレイリスト
player-playlist-new = 新しいプレイリスト
player-playlist-name = プレイリスト名
player-playlist-create = 作成
player-playlist-rename = 名前の変更
player-playlist-delete = プレイリストを削除する
player-playlist-add = プレイリストに追加
player-playlist-remove = 削除する
player-playlist-play = 遊ぶ
player-playlist-empty = プレイリストは作成されていません
player-playlist-empty-items = 空のプレイリスト
player-playlist-add-current = + 現在のメディアを追加
player-playlist-created = プレイリストが作成されました
player-playlist-deleted = プレイリストが削除されました
player-playlist-renamed = プレイリストの名前が変更されました
