...
settings-create-api-key = Crear clave API
settings-api-key-name = Nombre clave
settings-api-key-scopes = Ámbitos (separados por comas)
settings-api-key-scopes-hint = Déjelo vacío para el ámbito de "usuario" predeterminado.
settings-api-key-expiry = Vence en (días)
settings-api-key-expiry-hint = Déjelo vacío sin vencimiento.
settings-add-webhook = Agregar webhook
settings-webhook-url = URL de webhook
settings-webhook-events = Eventos (separados por comas)
settings-webhook-events-hint = Déjelo vacío para recibir todos los eventos.
...
oauth-not-connected = No conectada
...
cards-add-first = Añadir su primera tarjeta
cards-none = Aún no hay tarjetas guardadas
cards-empty-hint = Añada una tarjeta para habilitar la facturación automática y pagos más rápidos. Será redirigido a nuestro proveedor de pagos seguro para introducir los datos de su tarjeta.
cards-default = Predeterminada
cards-set-default = Establecer como predeterminada
cards-default-btn = Tarjeta predeterminada
cards-remove = Eliminar
cards-remove-confirm = ¿Eliminar esta tarjeta?
cards-expires = Vence
cards-load-error = No se pudieron cargar las tarjetas guardadas.
cards-add-error = No se pudo añadir una tarjeta
cards-default-error = No se pudo actualizar la tarjeta predeterminada
cards-remove-error = No se pudo eliminar la tarjeta
...
compliance-framework-version = Versión
compliance-framework-description = Descripción
compliance-create-framework = Crear Marco
compliance-controls = Controles
compliance-add-control = Añadir Control
compliance-control-id = ID del Control
compliance-control-title = Título
compliance-control-category = Categoría
compliance-control-description = Descripción
compliance-mandatory = Obligatorio
compliance-optional = Opcional
compliance-evidence = Evidencias
compliance-attach-evidence = Adjuntar Evidencia
compliance-evidence-path = Ruta del archivo (artefacto en drive)
compliance-evidence-type = Tipo
compliance-approve = Aprobar
compliance-covered = Cubierto
compliance-no-evidence = Sin evidencia
compliance-export-csv = Exportar CSV
compliance-archive = Archivar
...
sources-connector-description = Descripción
sources-connector-schedule = Programación de sincronización (cron)
sources-connector-type = Tipo
sources-connector-host = Host
sources-connector-port = Puerto
sources-connector-database = Base de datos
sources-connector-username = Usuario
sources-connector-password = Contraseña
sources-connector-base-url = URL base
sources-connector-api-key = Clave de API
sources-connector-credentials-hint = Las credenciales se almacenan en Vault y nunca se vuelven a mostrar después de guardar.
sources-create-connector = Crear Conector
sources-test-connector = Probar
sources-sync-now = Sincronizar ahora
sources-remove-connector = Eliminar
...
vdi-rdp = RDP
vdi-vnc = VNC
attendant-attach = Adjuntar archivo
attendant-emoji = Emoji
attendant-uploading = Subiendo...
attendant-attach-error = Error al subir
attendant-emoji-search = Buscar emoji...
meet-record = Grabar
meet-record-title = Grabar Reunión
meet-recording = Grabando
meet-recordings = Grabaciones
meet-recordings-empty = Aún no hay grabaciones

player-playlists = Listas de reproducción
player-playlist-new = Nueva lista de reproducción
player-playlist-name = Nombre de la lista de reproducción
player-playlist-create = crear
player-playlist-rename = Cambiar nombre
player-playlist-delete = Eliminar lista de reproducción
player-playlist-add = Agregar a la lista de reproducción
player-playlist-remove = Quitar
player-playlist-play = Jugar
player-playlist-empty = No se ha creado ninguna lista de reproducción
player-playlist-empty-items = Lista de reproducción vacía
player-playlist-add-current = + Agregar medios actuales
player-playlist-created = Lista de reproducción creada
player-playlist-deleted = Lista de reproducción eliminada
player-playlist-renamed = Lista de reproducción renombrada
