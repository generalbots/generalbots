...
setTimeout(function () {
  ...
  if (document.getElementById("window-tasks") && document.getElementById("window-tasks").querySelector(".tasks-app")) {
    initTasksApp();
  }
}, 100);
...
function renderManifestProgress(
  ...
  if (!progressLog) {
    progressLog = document.getElementById("window-tasks").querySelector(".taskmd-progress-content");
    console.log(
...
function updateStatusFromProgress(message, step) {
  const statusContent = document.getElementById("window-tasks").querySelector(".taskmd-status-content");
...
function updateDetailTerminal(taskId, message, step, activity) {
  ...
  if (!terminalOutput) {
    ...
    terminalOutput = document.getElementById("window-tasks").querySelector(".taskmd-terminal-output");
  }

  if (!terminalOutput) {
    // Try generic terminal output
    terminalOutput = document.getElementById("window-tasks").querySelector(".terminal-output-rich");
  }
...
function updateTerminalWithMarkdown(taskId, markdown) {
  ...
  if (terminalOutput) {
    ...
    const genericTerminal = document.getElementById("window-tasks").querySelector(".taskmd-terminal-output");
    if (genericTerminal) {
...
function addTerminalLine(terminal, message, step, activity) {
  const timestamp = new Date().toLocaleTimeString("en-US", { hour12: false }, 100);
...
function updateDetailProgress(taskId, current, total, percent) {
  const progressFill = document.getElementById("window-tasks").querySelector(".progress-fill-rich");
  const progressLabel = document.getElementById("window-tasks").querySelector(".progress-label-rich");
  const stepInfo = document.getElementById("window-tasks").querySelector(".meta-estimated");
