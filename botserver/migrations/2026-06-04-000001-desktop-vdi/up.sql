...
CREATE INDEX idx_desktop_connection_log_user ON desktop_connection_log(user_id, connected_at DESC);
CREATE INDEX idx_desktop_connection_log_session ON desktop_connection_log(session_id);
