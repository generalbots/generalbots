...
DROP INDEX IF EXISTS idx_compliance_audit_log_created;
DROP INDEX IF EXISTS idx_compliance_audit_log_resource;
DROP INDEX IF EXISTS idx_compliance_audit_log_user;
DROP INDEX IF EXISTS idx_compliance_audit_log_org_bot;
