...
CREATE INDEX idx_gl_accounts_bot ON gl_accounts(bot_id);
...
CREATE INDEX idx_gl_entries_bot ON gl_journal_entries(bot_id);
CREATE INDEX idx_gl_entries_status ON gl_journal_entries(status);
...
CREATE INDEX idx_gl_lines_entry ON gl_journal_lines(entry_id);
...
CREATE INDEX idx_inventory_bot ON inventory_items(bot_id);
...
CREATE INDEX idx_po_bot ON purchase_orders(bot_id);
