...
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING 'Error creating meet_recordings table: %', SQLERRM;
END $$;
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING 'Error creating meet_transcriptions table: %', SQLERRM;
END $$;
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING 'Error creating meet_minutes table: %', SQLERRM;
END $$;
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING 'Error creating meet_minute_signatures table: %', SQLERRM;
END $$;
