use crate::llm_assist_types::LlmAssistConfig;
use log::info;
...
impl LlmAssistConfig {
    pub fn from_config(bot_id: Uuid, work_path: &str) -> Self {
        ...
        info!(
            ...
            config.tips_enabled, config.polish_enabled,
            config.smart_replies_enabled, config.auto_summary_enabled, config.sentiment_enabled
        );
