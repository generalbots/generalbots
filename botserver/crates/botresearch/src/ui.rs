...
pub async fn handle_research_list_page<S: ResearchState>(
...
pub async fn handle_research_detail_page<S: ResearchState>(
    State(_state): State<Arc<S>>,
...
<body>
<div class="container">
<a href="/suite/research" class="back-link">&larr; Back to Projects</a>
...
pub async fn handle_research_new_page<S: ResearchState>(
    State(_state): State<Arc<S>>,
) -> Html<String> {
    let html = r#"<!DOCTYPE html>
<html lang="en">
...
pub fn configure_research_ui_routes<S: ResearchState>() -> Router<Arc<S>> {
    Router::new()
