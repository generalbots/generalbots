...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Ord, PartialOrd, Eq, Default)]
...
pub struct ExecutionLog {
    ...
    pub level: crate::app_logs::LogLevel,
    pub message: String,
...
pub struct DecisionOption {
    ...
    pub risk_level: crate::safety_layer::RiskLevel,
}
...
pub struct PendingApproval {
    ...
    pub simulation_result: Option<crate::safety_layer::SimulationResult>,
...
pub struct RiskSummary {
    pub overall_risk: crate::safety_layer::RiskLevel,
    pub data_risk: crate::safety_layer::RiskLevel,
    pub cost_risk: crate::safety_layer::RiskLevel,
    pub security_risk: crate::safety_layer::RiskLevel,
    pub compliance_risk: crate::safety_layer::RiskLevel,
...
pub struct RiskFactor {
    ...
    pub description: String,
    pub probability: f64,
    pub impact: crate::safety_layer::RiskLevel,
