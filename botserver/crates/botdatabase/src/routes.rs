...
pub fn configure() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/api/database/table/:name/row/:id", delete(handlers::delete_row).put(handlers::update_row_by_pk))
        .route("/api/database/table/:name/export", get(handlers::export_table_csv))
