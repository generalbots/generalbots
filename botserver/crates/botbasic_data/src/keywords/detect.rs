...
pub fn register_detect_keyword(state: Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
...
async fn detect_anomalies_in_table(
    ...
    let columns = get_table_columns(state.clone(), table_name, bot_id)?;
