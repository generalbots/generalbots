...
mod tests {
    ...
    fn registry_registers_every_generic_provider_slug() {
        let slugs = [
            "ahrefs", "algolia", "amplitude", "apollo",
            "attio", "beehiiv", "bigcommerce", "cal_com",
            "calendly", "canny", "clickup", "cloudflare",
            "coinbase", "crunchbase", "cursor", "databricks",
            "devin", "dhl", "docusign", "dropbox",
            ...
            "notion", "paddle", "paypal", "phantombuster",
            "philips_hue", "pinterest", "posthog", "postmark",
            "printful", "raindrop", "ramp", "readwise",
            "reddit", "resend", "salesforce", "sentry",
            "slack", "smartsheet", "splunk", "spotify",
            "square", "squarespace", "streak", "supabase",
            "todoist", "trello", "typeform", "upstash_redis",
            "vercel", "whop", "wise", "woocommerce",
            "x", "xero_accounting", "ynab", "zendesk",
            "zoom", "plain", "ashby", "bluesky",
        ];
