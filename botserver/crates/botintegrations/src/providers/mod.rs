...
pub fn registry() -> Vec<Arc<dyn ProviderAdapter>> {
    vec![
        ...
        Arc::new(generic::GenericAdapter::new(&generic::startups::CRUNCHBASE_SPEC)),
        Arc::new(generic::GenericAdapter::new(&generic::startups::GREENHOUSE_SPEC)),
        ...
        Arc::new(generic::GenericAdapter::new(&generic::social_messaging::NEWSCATCHER_SPEC)),
