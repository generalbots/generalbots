...
pub async fn list_connectors() -> Result<Json<serde_json::Value>, (StatusCode, String)> {
    ...
    struct Row {
        ...
        #[diesel(sql_type = diesel::sql_types::Text)] endpoint: String,
        #[diesel(sql_type = diesel::sql_types::Text)] status: String,
        #[diesel(sql_type = diesel::sql_types::Nullable<diesel::sql_types::Jsonb>)] config: Option<serde_json::Value>,
...
pub async fn list_etl() -> Result<Json<serde_json::Value>, (StatusCode, String)> {
    ...
    struct Row {
        ...
        #[diesel(sql_type = diesel::sql_types::Text)] target: String,
        #[diesel(sql_type = diesel::sql_types::Text)] schedule: String,
        #[diesel(sql_type = diesel::sql_types::Text)] status: String,
        #[diesel(sql_type = diesel::sql_types::Nullable<diesel::sql_types::Timestamptz>)] last_run: Option<chrono::DateTime<Utc>>,
        #[diesel(sql_type = diesel::sql_types::Timestamptz)] created_at: chrono::DateTime<Utc>,
    }
    let rows: Vec<Row> = diesel::sql_query(
