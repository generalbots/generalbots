...
pub async fn handle_dashboards_list_page(State(_state): State<Arc<DashboardsState>>) -> Html<String> {
...
pub async fn handle_dashboard_new_page(State(_state): State<Arc<DashboardsState>>) -> Html<String> {
    let html = r#"<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
pub fn configure_dashboards_ui_routes() -> Router<Arc<DashboardsState>> {
    Router::new()
