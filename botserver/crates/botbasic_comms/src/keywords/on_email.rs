...
pub fn on_email_keyword(state: &Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
...
fn register_on_email(state: &Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
