...
<div class="sl-modal-body" hx-get="/suite/slides/forms/share" hx-vals='{{"presentation_id":"{id}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/ai" hx-vals='{{"presentation_id":"{id}"}}' hx-trigger="load" hx-swap="innerHTML">
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/new-slide" hx-vals='{{"presentation_id":"{id}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id)
    ))
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/insert-element" hx-vals='{{"presentation_id":"{id}","slide_index":"{idx}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
        idx = idx
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/add-text" hx-vals='{{"presentation_id":"{id}","slide_index":"{idx}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
        idx = idx
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/add-image" hx-vals='{{"presentation_id":"{id}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id)
    ))
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/add-shape" hx-vals='{{"presentation_id":"{id}","slide_index":"{idx}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
        idx = idx
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/add-chart" hx-vals='{{"presentation_id":"{id}","slide_index":"{idx}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
        idx = idx
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/add-table" hx-vals='{{"presentation_id":"{id}","slide_index":"{idx}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
        idx = idx
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/notes" hx-vals='{{"presentation_id":"{id}","slide_index":"{idx}","notes":"{notes}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
        idx = idx,
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/background" hx-vals='{{"presentation_id":"{id}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id)
    ))
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/transition" hx-vals='{{"presentation_id":"{id}","slide_index":"{idx}","transition_type":"{ttype}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
        idx = idx,
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/animation" hx-vals='{{"presentation_id":"{id}","type":"{atype}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id),
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/export" hx-vals='{{"presentation_id":"{id}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id)
    ))
...
<div class="sl-modal-body" hx-get="/suite/slides/forms/master" hx-vals='{{"presentation_id":"{id}"}}' hx-trigger="load" hx-swap="innerHTML"></div>
</div>
</div>"##,
        id = html_escape(id)
    ))
