...
pub fn register_error_functions(state: &Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
...
pub fn throw_keyword(_state: &Arc<dyn BasicRuntime>, _user: UserSession, engine: &mut Engine) {
    engine.register_fn(
        "THROW",
...
pub fn error_keyword(_state: &Arc<dyn BasicRuntime>, _user: UserSession, engine: &mut Engine) {
...
pub fn is_error_keyword(_state: &Arc<dyn BasicRuntime>, _user: UserSession, engine: &mut Engine) {
...
pub fn assert_keyword(_state: &Arc<dyn BasicRuntime>, _user: UserSession, engine: &mut Engine) {
    engine.register_fn(
        "ASSERT",
...
pub fn log_error_keyword(_state: &Arc<dyn BasicRuntime>, _user: UserSession, engine: &mut Engine) {
