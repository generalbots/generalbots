...
pub fn register_qrcode_keywords(state: Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
...
pub fn register_qr_code_keyword(state: Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
