...
use botmultimodal::{
    BotModelsConfig, BotModelsClient, ConfigProvider, ImageGeneratorConfig, VideoGeneratorConfig,
};
...
fn spawn_multimodal<F>(name: &'static str, fut: F) -> Result<Dynamic, Box<EvalAltResult>>
where
