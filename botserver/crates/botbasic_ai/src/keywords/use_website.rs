...
pub fn use_website_keyword(state: Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
...
pub fn register_use_website_function(state: Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
    let state_clone = Arc::clone(&state);
    let user_clone = user.clone();
...
pub fn clear_websites_keyword(state: Arc<dyn BasicRuntime>, user: UserSession, engine: &mut Engine) {
    let state_clone = Arc::clone(&state);
    let user_clone = user;
