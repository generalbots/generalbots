...
Load knowledge base collections into the current session:

```basic
USE KB "policies"
USE KB "procedures"

# Now system AI has access to these collections during conversations
TALK "What would you like to know about policies or procedures?"
# System AI automatically searches the KB when responding to users
```

### CLEAR KB

Remove loaded knowledge bases:

```basic
CLEAR KB "policies"  # Remove specific
CLEAR KB             # Clear all
```
...
# System AI now has access to all loaded KBs
TALK "How can I help you with our products?"
# System AI automatically searches KBs when answering
```
...
# System AI automatically uses loaded KBs to answer
```
...
# System AI can now discuss research topics
TALK "What research topic would you like to explore?"
# System AI searches papers and citations automatically
```
